...
if(isset($_POST['email'])) {
    ...
    $email_from = "webpage@miradordelcastillo.com";

    $email_subject = utf8_decode ("Mensaje Página Web Mirador del castillo");
...
// create email headers
    ...
    if ($mail_status) {
        ...
        echo 'Su mensaje no pudo ser enviado. Puede contactarse directamente con nosotros a mail@miradordelcastillo.com';
    }
}
die();
?>